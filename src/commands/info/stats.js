...
module.exports = class StatsCommand extends Command {
  constructor(client) {
    super(client, {
      ...
      usage: 'stats',
      description: 'Fetches Lonewolf\'s statistics.',
  ...
  async run(message) {
    ...
    const embed = new MessageEmbed()
      .setTitle('Lonewolf\'s Statistics')
      ...
      .addField(
        'Links', 
        '**[Invite Me](https://discord.com/api/oauth2/authorize?client_id=795952530735104010&permissions=3757964662&scope=bot) | ' +
